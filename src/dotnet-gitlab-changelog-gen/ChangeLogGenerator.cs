...
namespace dotnet_gitlab_changelog_gen
{
    public class ChangeLogGenerator
    {
        ...
        async Task<string> getGitlabIssuesAsync()
        {
            ...
            string result = "# Changelog" + System.Environment.NewLine;
            result += "This doc is generated by [gitlab-changelog-generator]()." + System.Environment.NewLine;
            //we have 3 sections, feature, bug, enhance
            result += "## 🔥 Features" + System.Environment.NewLine;
            issueData.Where(i => i.labels.Contains(feature)).ToList().ForEach(i => 
            {
                result += "* " + i.title + " #" + i.iid + System.Environment.NewLine;
            });
            result += "## 🐞 Bugs" + System.Environment.NewLine;
            issueData.Where(i => i.labels.Contains(bug)).ToList().ForEach(i => 
            {
                result += "* " + i.title + " #" + i.iid + System.Environment.NewLine;
            });
            result += "## 🚀 Enhances" + System.Environment.NewLine;
